...
import {DATAS} from 'common/config'
import request, {api} from 'common/request'
import redPacket from 'assets/images/icon-red-packet.png'
  ...
  constructor (props) {
    ...
    this.onLoan = () => {
      if (navigator.userAgent.indexOf('kdxj') >= 0) {
        request(`http://credit.xianjincard.com/credit-info/login-mjp-jjp`)
                ...
                .then(response => {
                  try {
                    ...
                    if (/android/i.test(navigator.userAgent)) {
                      ...
                      window.location.href = `xjbk915164674://`
                    }
                  }
                })
      } else {
    ...
    let script = document.createElement('script');
        ...
        script.onload = () => {
            let share = document.createElement('script');
                share.src = api('https://credit.xianjincard.com/act/wx-share?key=doublepei1')
